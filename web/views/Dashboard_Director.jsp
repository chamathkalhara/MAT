...
<body class="body_font">
    ...
    <div class="grid_container work_arena_adjustments ">
        ...
        <div class="row dashboard_components">
            <div class="column_one employee component " id="employee">
        ...
        <div class="row dashboard_components">
            ...
            <div class="column_one leave component " id="allowance">
            ...
            <div class="column_one appraisals component " id="appraisals">
            ...
            <div class="column_one reports component " id="reports">
